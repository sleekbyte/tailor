...
public class PrinterTest {
    ...
    private static final boolean COLOR_OUTPUT = false;

    private File inputFile = new File("abc.swift");
    private Printer printer = new Printer(inputFile, Severity.ERROR, COLOR_OUTPUT);
    private Printer warnPrinter = new Printer(inputFile, Severity.WARNING, COLOR_OUTPUT);
