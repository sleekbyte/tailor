...
public class SemicolonTest extends RuleTest {
    ...
    protected void addAllExpectedMsgs() {
        ...
        addExpectedMsg(30, 10, Severity.WARNING, Messages.STATEMENTS);
        addExpectedMsg(35, 10, Severity.WARNING, Messages.STATEMENTS);
        addExpectedMsg(40, 21, Severity.WARNING, Messages.STATEMENTS);
        addExpectedMsg(41, 6, Severity.WARNING, Messages.STATEMENTS);
        ...
        addExpectedMsg(53, 21, Severity.WARNING, Messages.STATEMENTS);
        addExpectedMsg(54, 10, Severity.WARNING, Messages.STATEMENTS);
        addExpectedMsg(57, 65, Severity.WARNING, Messages.STATEMENTS);
        addExpectedMsg(59, 73, Severity.WARNING, Messages.STATEMENTS);
        addExpectedMsg(61, 59, Severity.WARNING, Messages.STATEMENTS);
        addExpectedMsg(63, 6, Severity.WARNING, Messages.STATEMENTS);
