 ...
 */
public enum Rules {
    UPPER_CAMEL_CASE, LOWER_CAMEL_CASE, REDUNDANT_PARENTHESES, CONSTANT_K_PREFIX, MULTIPLE_IMPORTS, WHITESPACE,
    FUNCTION_WHITESPACE, CONSTANT_NAMING, BRACE_STYLE, FORCED_TYPE_CAST, TRAILING_WHITESPACE, TERMINATING_NEWLINE,
    LEADING_WHITESPACE, COMMENT_WHITESPACE, MAX_CLASS_LENGTH, MAX_STRUCT_LENGTH, MAX_CLOSURE_LENGTH, MAX_LINE_LENGTH,
    MAX_FUNCTION_LENGTH, MAX_FILE_LENGTH, MAX_NAME_LENGTH, TERMINATING_SEMICOLON;
