...
public enum Rules {
    ...
    static {
        ...
        BRACE_STYLE.link = BASE_STYLE_GUIDE_LINK + BRACE_STYLE.getName();
        ...
        COMMENT_WHITESPACE.link = BASE_STYLE_GUIDE_LINK + COMMENT_WHITESPACE.getName();
        ...
        CONSTANT_K_PREFIX.link = BASE_STYLE_GUIDE_LINK + CONSTANT_K_PREFIX.getName();
        ...
        CONSTANT_NAMING.link = BASE_STYLE_GUIDE_LINK + CONSTANT_NAMING.getName();
        ...
        FORCED_TYPE_CAST.link = BASE_STYLE_GUIDE_LINK + FORCED_TYPE_CAST.getName();
        ...
        FUNCTION_WHITESPACE.link = BASE_STYLE_GUIDE_LINK + FUNCTION_WHITESPACE.getName();
        ...
        LEADING_WHITESPACE.link = BASE_STYLE_GUIDE_LINK + LEADING_WHITESPACE.getName();
        ...
        LOWER_CAMEL_CASE.link = BASE_STYLE_GUIDE_LINK + LOWER_CAMEL_CASE.getName();
        ...
        MAX_CLASS_LENGTH.link = BASE_STYLE_GUIDE_LINK + MAX_CLASS_LENGTH.getName();
        ...
        MAX_CLOSURE_LENGTH.link = BASE_STYLE_GUIDE_LINK + MAX_CLOSURE_LENGTH.getName();
        ...
        MAX_FILE_LENGTH.link = BASE_STYLE_GUIDE_LINK + MAX_FILE_LENGTH.getName();
        ...
        MAX_FUNCTION_LENGTH.link = BASE_STYLE_GUIDE_LINK + MAX_FUNCTION_LENGTH.getName();
        ...
        MAX_LINE_LENGTH.link = BASE_STYLE_GUIDE_LINK + MAX_LINE_LENGTH.getName();
        ...
        MAX_NAME_LENGTH.link = BASE_STYLE_GUIDE_LINK + MAX_NAME_LENGTH.getName();
        ...
        MAX_STRUCT_LENGTH.link = BASE_STYLE_GUIDE_LINK + MAX_STRUCT_LENGTH.getName();
        ...
        MULTIPLE_IMPORTS.link = BASE_STYLE_GUIDE_LINK + MULTIPLE_IMPORTS.getName();
        ...
        REDUNDANT_PARENTHESES.link = BASE_STYLE_GUIDE_LINK + REDUNDANT_PARENTHESES.getName();
        ...
        TERMINATING_NEWLINE.link = BASE_STYLE_GUIDE_LINK + TERMINATING_NEWLINE.getName();
        ...
        TERMINATING_SEMICOLON.link = BASE_STYLE_GUIDE_LINK + TERMINATING_SEMICOLON.getName();
        ...
        TRAILING_WHITESPACE.description = "Flag spaces or tabs after the last non-whitespace character on the line"
            + " until the newline.";
        TRAILING_WHITESPACE.link = BASE_STYLE_GUIDE_LINK + TRAILING_WHITESPACE.getName();
        ...
        UPPER_CAMEL_CASE.link = BASE_STYLE_GUIDE_LINK + UPPER_CAMEL_CASE.getName();
        ...
        WHITESPACE.description = "Flag whitespace violations around colon (:), arrow (->), and between construct"
            + " and opening brace ({).";
        WHITESPACE.link = BASE_STYLE_GUIDE_LINK + WHITESPACE.getName();
