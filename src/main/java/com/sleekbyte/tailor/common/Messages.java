...
public class Messages {
    ...
    public static final String NEWLINE_BEFORE = "must have at least one newline before it";
    public static final String NEWLINE_AFTER = "must have at least one newline after it";
